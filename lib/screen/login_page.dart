...
import 'package:kuis_123230041/screen/game_list_page.dart';
  ...
  void _login() {
    if (userC.text == "Andhika" && passC.text == "041") {
      ...
      Navigator.pushReplacement(
        context, 
        MaterialPageRoute(builder: (context) => GameListPage(username: userC.text))
      );
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Silahkan login untuk download game",
              style: TextStyle(
                color: Colors.grey
              ),
            ),
